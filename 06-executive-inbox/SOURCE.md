...
| **Trigger**    | Schedule                                           |
| **Node Count** | 41                                                 |
| **Credentials**| Backstory MCP, LLM API (Claude, OpenAI, Gemini, etc.), Email (Gmail, Outlook, IMAP), Messaging (Slack, Teams, Email), Project Management (Jira, Asana, etc.) — optional |
...
3. **Enrich with Account Context** — For each customer email, queries Backstory MCP and Project Management (Jira, Asana, etc.) to pull account status, recent activity, open tickets, and relationship history.
...
| `mcpClientTool`          | Backstory and Project Management integration |
