...
2. **Gather the evidence in parallel:**
   ...
   - `ask_sales_ai_about_opportunity` — "Queries Backstory for any existing engagement with the MQL's account: past meetings, email history, known contacts, prior opportunities."
