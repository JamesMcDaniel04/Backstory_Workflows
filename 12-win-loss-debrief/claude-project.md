...
2. **Gather the evidence in parallel:**
   ...
   - `ask_sales_ai_about_opportunity` — "Analyze the full timeline, identify key moments (first exec meeting, proposal sent, competitor mention, engagement gaps), and generate a structured debrief."
