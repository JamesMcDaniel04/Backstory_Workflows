# Claude.ai Project Template: Activity Gap Detector
...
2. **Gather the evidence in parallel:**
   ...
   - `ask_sales_ai_about_opportunity` — "Analyze each flagged rep's patterns, identify specific gaps (e.g., low multi-threading, no exec outreach), and generate coaching recommendations."
