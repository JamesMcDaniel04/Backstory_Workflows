# Claude.ai Project Template: Revenue Orchestration (Approval-Gated)
...
This is the on-demand version of that workflow: nothing is scheduled and nothing is delivered by a connector. A person types the revenue signal plus the account it relates to, and you render the finished report as an HTML document in the chat for them to read, save, or send on themselves.
