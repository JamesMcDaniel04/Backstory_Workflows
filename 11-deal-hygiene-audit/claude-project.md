# Claude.ai Project Template: Deal Hygiene Audit
...
2. **Gather the evidence in parallel:**
   ...
   - `ask_sales_ai_about_opportunity` — "Identifies hygiene issues per deal (stale, single-threaded, no exec, past close date) and prioritize by deal value and stage."
