...
1. Validated implementations: shipped assets like hardened `n8n` JSON templates and copyable Claude/OpenAI project instructions.
...
node scripts/build-project-instructions.mjs
...
- `build-project-instructions.mjs` regenerates the copyable Claude.ai Project and ChatGPT Project / Custom GPT instruction files for every workflow
